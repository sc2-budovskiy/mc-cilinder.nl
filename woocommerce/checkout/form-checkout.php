...
<form name="checkout" method="post" class="checkout woocommerce-checkout clear" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
    <div class="checkout-col col-md-4 col-sm-12 col-xs-12 billing-col">
        <div class="cc-inner">
            <div class="checkout-title">Naam en verzendgegevens</div>
            <div style="height:45px"></div>

            <?php if ( isset( $nm_globals['checkout_login_message'] ) ) : ?>
                <a href="#" class="showlogin login-title">Inloggen</a>
            <?php
            endif ?>
    ...
    <div id="order_review" class="woocommerce-checkout-review-order">
        ...
        <?php //wc_get_template("checkout/new-review-order.php", array("checkout" => $checkout)); ?>
    </div>
